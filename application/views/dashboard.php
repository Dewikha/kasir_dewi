        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-primary">
              <div style="background-color:#9BB8CD" class="inner">
                <h3 id="transaksi_hari">0</h3>
                <p>Transaksi Hari Ini</p>
              </div>
              <div class="icon">
                <i style="background-color:#9BB8CD" class="fas fa-shopping-cart"></i>
              </div>
              <a href="<?php echo site_url('laporan_penjualan') ?>" class="small-box-footer"  style="background-color:#9BB8CD">
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-indigo">
              <div style="background-color:#F2D388" class="inner">
                <h3 id="transaksi_terakhir">0</h3>
                <p>Produk Transaksi Terakhir</p>
              </div>
              <div class="icon">
                <i style="background-color:#F2D388"class="fas fa-money-bill"></i>
              </div>
              <a href="<?php echo site_url('laporan_penjualan') ?>" class="small-box-footer" style="background-color:#F2D388">
                More Info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-teal">
              <div style="background-color:#C98474" class="inner">
                <h3 id="stok_hari">0</h3>
                <p>Stok Masuk Hari Ini</p>
              </div>
              <div class="icon">
                <i style="background-color:#C98474" class="fas fa-archive"></i>
              </div>
              <a href="<?php echo site_url('laporan_stok_masuk') ?>" class="small-box-footer" style="background-color:#C98474">
                More Info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
